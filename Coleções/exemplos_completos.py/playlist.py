# Exemplo completo de cadastro CRUD usando apenas listas.
...
"""
CRUD é um acrônimo usado no desenvolvimento de software que representa as quatro operações básicas de manipulação de dados em um sistema:
...
-> CRUD define as ações essenciais que qualquer aplicação que manipule dados deve permitir.

Por exemplo, em um sistema de cadastro de clientes:
Create: cadastrar um novo cliente.
Read: listar ou buscar clientes cadastrados.
Update: alterar informações de um cliente.
Delete: excluir um cliente do cadastro.
"""        